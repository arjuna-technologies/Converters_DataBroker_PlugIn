...
@Startup
@Singleton
public class DeprecatedConvertersFactoriesSetup
{
    @PostConstruct
    public void setup()
    {
        ...
        Data2WrapperMapDataProcessorFactory          data2WrapperMapDataProcessorFactory          = new Data2WrapperMapDataProcessorFactory("(Deprecated) Data2WrapperMap Data Processor Factory", data2WrapperMapDataProcessorFactoryProperties);
        Data2DirectWrapperMapDataProcessorFactory    data2DirectWrapperMapDataProcessorFactory    = new Data2DirectWrapperMapDataProcessorFactory("(Deprecated) Data2DirectWrapperMap Data Processor Factory", data2DirectWrapperMapDataProcessorFactoryProperties);
        Data2FormattedWrapperMapDataProcessorFactory data2FormattedWrapperMapDataProcessorFactory = new Data2FormattedWrapperMapDataProcessorFactory("(Deprecated) Data2FormattedWrapperMap Data Processor Factory", data2FormattedWrapperMapDataProcessorFactoryProperties);
    ...
    public void cleanup()
    {
        _dataFlowNodeFactoryInventory.removeDataFlowNodeFactory("(Deprecated) Data2WrapperMap Data Processor Factory");
        _dataFlowNodeFactoryInventory.removeDataFlowNodeFactory("(Deprecated) Data2DirectWrapperMap Data Processor Factory");
        _dataFlowNodeFactoryInventory.removeDataFlowNodeFactory("(Deprecated) Data2FormattedWrapperMap Data Processor Factory");
    }
